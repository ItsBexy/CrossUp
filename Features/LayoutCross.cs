    ...
    public static partial class Layout
    {
        ...
        internal static class Cross
        {
            ...
            internal static void StoreXPos()
            {
                ...
                PluginLog.LogDebug(
                    $"Storing Cross Hotbar X Position; UnitBase: {Bars.Cross.Base.X}, Root Node: {Bars.Cross.Root.Node->X}");
            ...
            public static void RestoreXPos()
            {
                ...
                {
                    PluginLog.LogWarning("Exception: Couldn't restore Cross Hotbar X Position!\n" + ex);
                }
            }
        }
    }
